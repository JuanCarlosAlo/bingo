...
const currentRandomNumber = ()=>{return Math.floor(Math.random()*randomNumberArray.length)}
const randomNumber =()=>{
...
const setClassList=()=>{
    ...
    allBoxes.forEach(element => {
        if (element.dataset.number === numberToPlay) {
            console.log(element)
...
const currentNumberText=()=>{
   ...
   if (win=== false) {
    timeoutId = setTimeout(currentNumberText,500)
